            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Khu phố 6, Linh Trung, Thủ Đức, thành phố Hồ Chí Minh</span>
                            </li>
                            <li><a href="#"><span class="icon icon-phone"></span><span
                                    class="text">+84 035 6056 080</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">doanchuyendeweb@gmail.com</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
